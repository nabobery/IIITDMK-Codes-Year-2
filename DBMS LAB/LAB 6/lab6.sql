...
INSERT INTO iiitdm
VALUES('Jagadeesh','CS20B1044','Ashoka');
INSERT INTO iiitdm
...
INSERT INTO student
VALUES('CS20B1044','Avinash','CSE','CS208','Ashoka','30');
INSERT INTO student
...
-- QUERY 3
SELECT * FROM faculty WHERE subject NOT IN (SELECT subject FROM course INNER JOIN student ON course.course_id = student.course_id AND student.student_id = 'CS20B1044');
