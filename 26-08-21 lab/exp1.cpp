...
class Volume {
    ...
    public:
        ...
        void compareSphere(Volume v2){
            ...
            cin >> this->radius;
            float volume1 = sphere(*this,this->radius);
            cout<<"Please enter the radius for Sphere2: ";
            cin >> v2.radius;
            float volume2 = sphere(v2, v2.radius);
            if(volume1 > volume2){
            ...
            case 9:
                ...
                switch(option){
                    case 1:
                        ...
                        break; 
                    case 2:
                        cout <<"Volume of Cuboid1 is equal to volume of Cuboid2 \n";
                        break;
                    default:
            ...
            case 10:
                ...
                switch(option){
                    case 1:
                        ...
                        break;
                    case 2:
                        cout <<"Volume of Sphere1 is equal to volume of Sphere2 \n";
                        break;
                    default:
                        cout<<"Wrong choice, Please try again!\n";
                }
