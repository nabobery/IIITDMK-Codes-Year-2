...
_start:
  ...
  mov ebx, [radix]        ; move radix=8 to ebx which will be used for dividing
...
section .data
  num dd 420                          ; Given number is 420 which in octal should be 644
  counter dd 0
  radix dd 8
  msg db "Given Number is "			                      ; string to be printed
  len equ $ - msg 			                              ; length of the string
  msg1 db "The given Number in Octal is: "                            ; string to be printed
