...
class savingsAccount : public Account {
    public:
        ...
        savingsAccount* newAccount(int accountnumber, double bal, double interestRate){
            savingsAccount temp(accountnumber, bal, interestRate);
            savingsAccount *ptr = new savingsAccount();
            ptr = &temp;
            return ptr;
        }
...
class checkingAccount : public Account {
    public:
        ...
        checkingAccount newAccount(int accountnumber, double bal, double Fee){
            checkingAccount temp(accountnumber, bal, Fee);
            return temp;
        }
...
/*class savings_linkedlist{
    savings_linkedlist *head;
    savings_linkedlist *next;
    void addAccount(int accountnumber, double bal, double interestRate){
            savings_linkedlist* ptr = new savings_linkedlist;
            savingsAccount obj(accountnumber, bal, interestRate);
            if(head == NULL){
                head = &obj;
                head->next = NULL;
        ...
        switch(choice){
            case 1:
                ...
                if(account_choice== 1){
                    ...
                    //savingsAccount obj = temp1.newAccount(account_no, balance, interest_rate);
                    //savingsAccount *temp = &obj;
                    temp = temp->newAccount(account_no, balance, interest_rate);
                    ...
                    checkingAccount object = temp2.newAccount(account_no, balance, fee);
