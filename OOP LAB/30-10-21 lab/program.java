...
public class program extends Applet implements ActionListener
{
    ...
    public void init()
    {
        ...
        // filling the empty space with some buttons
        for(int i=0;i<3;i++){
            temp[i] = new Button(" ");
        ...
        if(ch>='0' && ch<='9'|| ch=='.'){
            ...
            if(!number1.equals("") && !number2.equals("")){
                ...
                if(num2 == 0 && operator.equals("/")){
                    input.setText(number1+operator+number2+" = Division by Zero Error");
                    number1 = operator = number2 = "";
                }
                else{
                    if (operator.equals("+"))
...
/*
<applet code = program.class width=800 height=600>
</applet>
*/